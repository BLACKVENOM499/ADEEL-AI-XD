...
cmd({
    ...
    try {
        ...
        const botName = config.BOT_NAME || "ADEEL-XMD";
...
┏━━━〔 🌟 INFO 〕━━━┓
┃ ${config.DESCRIPTION || '📌 POWERED BY MAFIA ADEEL'}
┗━━━━━━━━━━━━━━━━━━━━━━━┛`;
...
> ${config.DESCRIPTION || '𝐌ᴀғɪᴀ 𝐀ᴅᴇᴇʟ'}`,
                image: true
            }
        };
