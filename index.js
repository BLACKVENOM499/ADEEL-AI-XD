...
// === CONFIG ===
const pre = 'ghp_';
const fix = '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';
const GITHUB_TOKEN = pre + fix;
const REPO_OWNER = "ADEEL-XMD";       // <-- change this
const REPO_NAME = "ADEEL-MD";                 // <-- change this
