...
const {
  ...
  async function loadSession() {
    try {
        ...
        const session = config.SESSION_ID.startsWith('ADEEL-XMD~')
            ? config.SESSION_ID.replace("ADEEL-XMD~", "")
            : config.SESSION_ID;
  ...
  async function connectToWA() {
      console.log("[🔰] 𝐀𝐃𝚵𝚵𝐋-𝐌𝐃 Connecting to WhatsApp ⏳️...");
      ...
      conn.ev.on('connection.update', async (update) => {
          ...
          if (connection === 'close') {
              ...
              console.log('[🔰] 𝐀𝐃𝚵𝚵𝐋-𝐌𝐃 connected to WhatsApp ✅');
...
⭐ *Channel:* https://whatsapp.com/channel/0029VbC15ycFHWpubqmNWe0N
⭐ *GitHub:* https://github.com/ADEEL-XMD/ADEEL-AI-XD/fork`;
